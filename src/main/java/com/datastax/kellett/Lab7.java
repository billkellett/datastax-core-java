...
/*
In Lab 7 we examine Query paging using a DSE Search Index.
*/
...
public class Lab7 {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        System.out.println("Starting Lab 7");
        ...
        */
        ...
        mySession.execute("DROP KEYSPACE IF EXISTS lab7;");
        ...
        */
        ...
        rs = mySession.execute(
                "CREATE TABLE IF NOT EXISTS "
                        + "lab7.customers ( acct_no int, first_name text, last_name text, PRIMARY KEY (acct_no));"
        );
        ...
        */
        ...
        PreparedStatement cqlInsert = mySession.prepare(
                "INSERT INTO lab7.customers (acct_no, first_name, last_name) VALUES (?, ?, ?)");
        ...
        /*
        Now create the Search Index for the customers table
        */
        rs = mySession.execute(
                "CREATE SEARCH INDEX ON lab7.customers;");

        // Sleep 10 seconds to make sure of consistency
        Thread.sleep(10000);
        ...
        Lab7PageReader pageReader = new Lab7PageReader();
        ...
        */
        ...
        while(getAnotherPage.equalsIgnoreCase("y") && !lastPage) {
            ...
            if (getAnotherPage.equalsIgnoreCase("y")) {
                ...
                Lab7PageReader pageReaderSubsequentPage = new Lab7PageReader();
        ...
        */
        ...
        System.out.println("Terminating execution of Lab 7.");
