...
/*
In Lab 3 we examine Prepared Statements.
Prepared Statements run more quickly because they are compiled once on each node as needed.
*/
...
public class Lab3 {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        */
        ...
        mySession.execute("DROP KEYSPACE IF EXISTS lab3;");

        ResultSet rs = mySession.execute(
                "CREATE KEYSPACE lab3 "
        ...
        */
        ...
        rs = mySession.execute(
                "CREATE TABLE IF NOT EXISTS "
                        + "lab3.customers ( acct_no int, first_name text, last_name text, PRIMARY KEY (acct_no));"
        );
        ...
        */
        ...
        PreparedStatement cqlInsert = mySession.prepare(
                "INSERT INTO lab3.customers (acct_no, first_name, last_name) VALUES (?, ?, ?)");
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                cqlInsertBound.enableTracing();

                // execute the bound statement
                mySession.execute(cqlInsertBound);
            }
        ...
        */
        ...
        System.out.println("Terminating execution of Lab 3.");
        exit(0);
